...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center bg-hero-pattern bg-cover bg-center bg-fixed overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-3/4 left-3/4 w-96 h-96 bg-gold rounded-full opacity-5 filter blur-3xl animate-pulse-slow"></div>
      </div>
      ...
      <div className="container mx-auto px-4 py-20 z-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-center md:text-right mb-10 md:mb-0">
            ...
            <p className="text-xl text-gray-300 mb-8 animate-fade-in animate-delay-200">
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4 sm:space-x-reverse rtl:space-x-reverse animate-fade-in animate-delay-300">
              ...
              behavior: 'smooth'
            })} className="border-white hover:bg-white/10 font-semibold rounded-none text-zinc-950">
                גלו את השירותים שלנו
              </Button>
            </div>
          </div>
          <div className="md:w-1/2 animate-fade-in animate-delay-400">
            <div className="relative">
              <div className="bg-gradient-to-br from-dark to-transparent p-8 rounded-2xl border border-gray-800 animate-float">
                ...
                <div className="space-y-3">
                  ...
                  <div className="h-4 bg-tech-blue/30 rounded-full w-2/3"></div>
                  <div className="mt-6 h-10 bg-tech-blue/20 rounded-md w-1/2 mb-4"></div>
                </div>
                <div className="absolute -bottom-4 -right-4 w-20 h-20 bg-gold/30 rounded-full blur-xl"></div>
                <div className="absolute -top-4 -left-4 w-16 h-16 bg-tech-blue/20 rounded-full blur-xl"></div>
              </div>
              <div className="absolute top-1/3 right-1/4 w-20 h-20 bg-gradient-to-r from-gold to-tech-blue rounded-full opacity-50 blur-xl"></div>
            </div>
          </div>
        </div>
      </div>
