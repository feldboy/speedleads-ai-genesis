...
const faqs: FaqItem[] = [
  ...
  {
    id: "faq_question_5",
    question: "האם אתם מציעים שירותי שיווק דיגיטלי בנוסף לפיתוח?",
    answer: "כן, בנוסף לפיתוח הטכנולוגי, אנו מציעים שירותי שיווק דיגיטלי משלימים כדי להבטיח שהפתרון שפיתחנו יגיע לקהל היעד שלכם. שירותים אלה כוללים קידום אורגני (SEO), פרסום ממומן (SEM/PPC), ניהול מדיה חברתית, שיווק בדוא\"ל, אופטימיזציה של שיעורי המרה (CRO), וניתוח מתקדם של ביצועים. אנו יכולים להציע חבילות משולבות או שירותים נפרדים בהתאם לצרכים שלכם."
  },
  {
    id: "faq_question_6",
