...
const AdvantageCard = ({ title, description, icon }: AdvantageCardProps) => (
  <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-t-2 border-tech-blue" data-aos="fade-up">
    ...
    <section id="advantages" className="py-20 bg-gray-100">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4" data-aos="fade-up">למה SpeedLeads.AI?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <AdvantageCard 
            ...
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-12 h-12" aria-hidden="true">
        ...
        <div className="mt-16 bg-white rounded-lg p-8 shadow-lg" data-aos="fade-up">
