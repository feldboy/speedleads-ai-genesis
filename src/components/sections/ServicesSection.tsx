    ...
    <section id="services" className="py-20 bg-white">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-gold to-tech-blue mx-auto mb-8" /> {/* This div could also be animated */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <ServiceCard 
            ...
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-12 h-12" aria-hidden="true">
                <title>Website Building Icon</title>
          ...
          <ServiceCard 
            ...
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-12 h-12" aria-hidden="true">
                <title>Landing Pages Icon</title>
          ...
          <ServiceCard 
            ...
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-12 h-12" aria-hidden="true">
                <title>AI Integrations Icon</title>
