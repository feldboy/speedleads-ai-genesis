...
const services: Service[] = [
  {
    ...
    description:
      "אתרי תדמית יוקרתיים ודפי נחיתה ממוקדי המרה המותאמים למותג שלך.",
    points: [
  ...
  },
  {
    ...
    title: "אייג׳נט מכירות ו -  CRM",
    subtitle: "חסוך זמן וכסף עם אוטומציות חכמות",
    description:
      "אייג׳נט מכירות בווצאפ שעובד בשיתוף פעולה מלא עם מערכת CRM פרטית ודואג לכל הליך המכירה.",
    points: [
    ...
    features: [
      ...
      "מערכות דיווח ומעקב אוטומטיות בממשק מלא עם ה - CRM",
  ...
  },
  {
    ...
    description:
      "פיתוח והטמעה של פתרונות בינה מלאכותית מותאמים לעסק שלך עם יתרון תחרותי ברור.",
    points: [
    ...
    >
      <div className="container mx-auto">
        <header className="text-center mb-20">
          <div
            className="inline-flex items-center gap-2 glass-liquid rounded-full px-6 py-2 mb-6"
            data-aos="fade-up"
          >
            <Shield className="w-4 h-4 text-tech-blue" />
            <span className="text-sm font-medium text-gray-300">
              פתרונות מקצועיים מובילים
            </span>
          </div>
          ...
          <div
            className="w-32 h-2 bg-gradient-to-l from-[color:var(--btn-from,#00f6ff)] to-[color:var(--btn-to,#00a7ff)] mx-auto mb-8 rounded-full shadow-lg shadow-tech-blue/30"
            data-aos="fade-up"
            data-aos-delay="150"
          />
          ...
          <p
            ...
            data-aos-delay="200"
          >
            אנחנו מתמחים בפיתוח פתרונות טכנולוגיים מתקדמים שמביאים תוצאות
            אמיתיות. כל פרויקט מותאם אישית לצרכים הייחודיים של העסק שלכם.
          </p>
        </header>
              ...
              >
                ...
                <div className="flex flex-col justify-between min-h-full">
                    ...
                    <div className="space-y-3 lg:space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <span className="text-lg lg:text-2xl font-bold bg-gradient-to-l from-[color:var(--btn-from,#00f6ff)] to-[color:var(--btn-to,#00a7ff)] bg-clip-text text-transparent">
                            {service.price}
                          </span>
                        ...
                        <Badge
                          variant="secondary"
                          className="bg-gradient-to-l from-[#00f6ff]/10 to-[#00a7ff]/10 text-transparent bg-gradient-to-l from-[color:var(--btn-from,#00f6ff)] to-[color:var(--btn-to,#00a7ff)] bg-clip-text font-medium px-2 py-1 text-xs"
                        >
                        ...
                        {service.trustSignals
                          ...
                          .map((signal, signalIndex) => (
                            <Badge
                              key={signalIndex}
                              variant="outline"
                              className="text-xs bg-green-500/10 text-green-400 border-green-500/30 px-2 py-1"
                            >
                  ...
                  <div className="mt-6 pt-4 border-t border-white/10">
                    <Button
                      size="lg"
                      className="w-full bg-gradient-to-l from-[color:var(--btn-from,#00f6ff)] to-[color:var(--btn-to,#00a7ff)] hover:brightness-110 text-white font-bold px-6 lg:px-8 py-3 lg:py-4 rounded-full transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl text-sm lg:text-base"
                      onClick={() =>
                        document
          ...
          <div className="inline-flex flex-col sm:flex-row gap-4">
            ...
            >
              <Button
                variant="outline"
                size="lg"
                className="border-2 border-gold text-gold hover:bg-gold hover:text-white font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-full shadow-lg hover:shadow-gold/25 transition-all duration-300 text-sm sm:text-base min-h-[44px]"
                data-aos="slide-left"
                data-aos-delay="400"
                data-aos-duration="600"
              >
