...
const Index = () => {
  ...
  const toggleAccessibilityMenu = () => {
    ...
    if (hasConsent && !accessibilityMenuOpen) {
      trackEvent('open_accessibility_menu', {});
    }
  };
  ...
  return (
    <div dir="rtl" lang="he" className="min-h-screen bg-white text-dark relative">
      ...
      <button 
        ...
        className="fixed top-20 right-6 bg-white text-dark border border-gray-300 rounded-full p-3 shadow-lg z-40 transition-all duration-300 hover:scale-110"
